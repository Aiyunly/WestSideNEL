    ...
    <div class="about-page">
        <div class="about-hero">
            ...
            <div class="about-hero-text">
                <h1 class="about-title">WestSide NEL</h1>
                <div class="about-version" id="about-version">...</div>
            </div>
        </div>
        <div class="about-card">
            <div class="about-section-title">版权信息</div>
            <p>Copyright &copy; 2026 WestSide. All Rights Reserved.</p>
            <p class="about-muted">Thank Codexus!</p>
            <p class="about-muted">Thank EastSideNEL!</p>
        </div>
        <div class="about-card">
...
async function loadAboutInfo() {
    ...
    document.getElementById('about-link-github')?.addEventListener('click', (e) => {
        e.preventDefault();
        Bridge.send('system:openUrl', { url: 'https://github.com/WestSide/oxygen' });
    });
